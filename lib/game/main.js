...
GameScreen = ig.Game.extend({
	...
	init: function() {
		...
		this.spawnMonster(3,null);
		this.spawnMonster(8,null);
		this.spawnMonster(10,null);
		this.spawnMonster(15,null);
		this.spawnMonster(18,'skeleton');
	},
	...
	spawnMonster: function(x,type) {
		...
		// if(rand < 0.5) {
		if(type) {
			var spawningEntity = this.spawningTable[type];
			console.log('EntityMonster: '+type);
		}
		else {
